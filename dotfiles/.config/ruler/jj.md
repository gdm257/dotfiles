...
- `gh` command fails to detect repo info.

To use `jj`, you could learn more details from:
- `jj help`, `jj help <subcommand>`, `jj help <subcommand> <subsubcommand>` for command help E.g. `jj help` `jj help bookmark` `jj help bookmark list`
